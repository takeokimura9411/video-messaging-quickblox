...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [QBSettings setApplicationID:40595];
    [QBSettings setAuthKey:@"xdAezO87WDZ-sUE"];
    [QBSettings setAuthSecret:@"eHW-5DwaTY3Y-rj"];
    [QBSettings setAccountKey:@"2AWsgx12sVECA3MoTsy1"];
